...
const SHARED_STYLES = `
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .see-more-wrap { text-align: center; margin-top: 44px; }
  .see-more-btn {
    ...
    background: rgba(91,30,255,0.08);
    transition: all 0.3s ease;
  }
  .see-more-btn:hover {
    color: #fff;
    border-color: rgba(0,229,255,0.7);
    background: rgba(91,30,255,0.18);
 ...
 */
function renderShell({ title, description, bodyHtml, activeIsBlog = false, wide = false, extraHead = '' }) {
  return `<!DOCTYPE html>
<html lang="es">
<head>
<meta charset="UTF-8">
