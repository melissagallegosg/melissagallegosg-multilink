...
/**
 * URL del perfil de Medium (para el botón "Ver más en Medium"), derivada
 * de la URL del feed quitando el segmento "/feed". Se puede sobreescribir
 * explícitamente con la variable de entorno MEDIUM_PROFILE_URL.
 */
function getProfileUrl() {
  if (process.env.MEDIUM_PROFILE_URL) return process.env.MEDIUM_PROFILE_URL;
  return getFeedUrl().replace('/feed/', '/');
}
